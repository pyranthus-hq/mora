...
| `internal/sharing/` | — | Transport-neutral paths/contracts, encrypted bucket transport, durable ledgers, and the owner-fenced `attempt.json` store/recovery lifecycle. |
