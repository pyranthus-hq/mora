...
| `internal/sharing` | `filippo.io/age` | Transport-neutral share security primitives: signing-key persistence, ed25519 envelopes, destination binding, TOFU/freshness verification, age-sealed manifests, size bounds, content addressing, and public-key fingerprints. Mora retains transports, consent, publication/import governance, and orchestration. |
