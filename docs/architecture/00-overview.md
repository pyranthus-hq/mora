...
| `internal/sharing` | `internal/atomicio`, `filippo.io/age` | Transport-neutral sharing contracts and security: durable publish/subscription ledger types and paths, strict name/scope grammar, canonical bucket locators, atomic registry persistence, signing keys, ed25519 envelopes, TOFU/freshness verification, age-sealed manifests, size bounds, content addressing, and fingerprints. Mora retains transports, consent, publication/import governance, and orchestration. |
