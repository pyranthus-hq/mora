...
func Classify(identity, displayName string) string { return classifyIdentity(identity, displayName) }
func IsShortcode(handle string) bool               { return isShortcode(handle) }
func IsPhoneNumber(handle string) bool             { return isPhoneNumber(handle) }
func IsArtifact(id, display string) bool           { return isArtifact(id, display) }
func IsRepo(id, display string) bool               { return isRepo(id, display) }
func IsStructuralNoise(handle string) bool         { return isStructuralNoise(handle) }

func IsDelimiter(r rune) bool { return isDelim(r) }
